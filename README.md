...
The Book Search Engine is a Google Books API search engine.

It's built GraphQL and Apollo Server, with a React front end, MongoDB database, and Node.js/Express.js server and API. 
